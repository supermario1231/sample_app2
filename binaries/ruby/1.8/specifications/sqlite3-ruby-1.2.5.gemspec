...
Note that this module is NOT compatible with SQLite 2.x.}
  ...
  s.extensions = [%q{ext/sqlite3_api/extconf.rb}]
  s.extra_rdoc_files = [%q{History.txt}, %q{Manifest.txt}, %q{README.txt}]
  s.files = [%q{History.txt}, %q{Manifest.txt}, %q{README.txt}, %q{ext/sqlite3_api/extconf.rb}]
  s.homepage = %q{http://sqlite3-ruby.rubyforge.org}
  s.rdoc_options = [%q{--main}, %q{README.txt}, %q{--main=README.txt}]
